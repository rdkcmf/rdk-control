...
*/
#ifndef __CTRLM_VOICE_IPC_IARM_LEGACY_H__
#define __CTRLM_VOICE_IPC_IARM_LEGACY_H__
#include "ctrlm_voice_ipc.h"
#include "libIBus.h"

class ctrlm_voice_ipc_iarm_legacy_t : public ctrlm_voice_ipc_t {
public:
    ctrlm_voice_ipc_iarm_legacy_t(ctrlm_voice_t *obj_voice);
    virtual ~ctrlm_voice_ipc_iarm_legacy_t() {}
...
private:
    enum legacy_ipc_state {
        EVENT_ALL,
        AWAIT_KW_VERIFICATION,
        IGNORE_ALL
    };

    legacy_ipc_state state;
    ctrlm_voice_ipc_event_session_begin_t session_begin_cached;
